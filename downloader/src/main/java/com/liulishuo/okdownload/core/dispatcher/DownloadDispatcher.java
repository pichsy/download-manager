...
public class DownloadDispatcher {
    ...
    private final List<DownloadCall> readyAsyncCalls = Collections.synchronizedList(new ArrayList<>());

    private final List<DownloadCall> runningAsyncCalls = Collections.synchronizedList(new ArrayList<>());
    private final List<DownloadCall> runningSyncCalls = Collections.synchronizedList(new ArrayList<>());

    // for enqueueing task during task is finishing
    private final List<DownloadCall> finishingCalls = Collections.synchronizedList(new ArrayList<>());
