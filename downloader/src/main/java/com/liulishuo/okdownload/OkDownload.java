...
public class OkDownload {
    ...
    /**
     * 设置最大并发数，默认是5
     * @param maxParallelRunningCount maxParallelRunningCount
     */
    ...
    /**
     * 设置下载任务到数据库的延迟时间，单位毫秒，默认是1500毫秒
     * @param delay delay
     */
    public static void setRemitToDBDelayMillis(int delay) {
        RemitStoreOnSQLite.setRemitToDBDelayMillis(delay);
    }
